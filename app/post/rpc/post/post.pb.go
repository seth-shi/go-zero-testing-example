...
func (x *PostRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type PostResponse struct {
	...
	ViewCount uint64 `protobuf:"varint,5,opt,name=viewCount,proto3" json:"viewCount,omitempty"`
}
...
func (x *PostResponse) GetCreatedAt() uint64 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
func (x *PostResponse) GetViewCount() uint64 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
var file_post_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x8a, 0x01, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x12, 0x1c, 0x0a, 0x09, 0x76, 0x69, 0x65, 0x77, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x09, 0x76, 0x69, 0x65, 0x77, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x34,
	0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x11, 0x2e,
...
var file_post_proto_depIdxs = []int32{
	0, // 0: post.Post.Get:input_type -> post.PostRequest
	1, // 1: post.Post.Get:output_type -> post.PostResponse
